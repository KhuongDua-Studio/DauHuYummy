...
_G.NameHub = "Made By Nguyễn Minh Nhật" -- ชื่อ Hub
_G.Title = "Đậu Hủ Yummy" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://15292700509"
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/VM7ESrzccs")
    wait(.1)
